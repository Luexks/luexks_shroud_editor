...
use egui::{Color32, Pos2, Rect, Shape, Stroke, lerp, pos2};
...
use crate::{
    ...
    shroud_editor::{ShroudEditor, render_shroud::RenderVertex},
};
...
//     let fill_color_gradient = fill_color_gradient;
...
pub fn polygon_fill_logic(
    render_vertices: &mut Vec<RenderVertex>,
    block_container: &BlockContainer,
    rect: Rect,
    vertices: Vec<Pos2>,
    offset: DisplayOriented3D,
